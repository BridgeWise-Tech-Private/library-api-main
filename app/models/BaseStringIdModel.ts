...
export type BaseEnhancedModelType = typeof BaseStringIdModel;

type ModelValidationType = 'Create' | 'Update';

export default class BaseStringIdModel extends BaseModel {
    ...
    @beforeCreate()
    public static async generateId(model: BaseStringIdModel): Promise<void> {
