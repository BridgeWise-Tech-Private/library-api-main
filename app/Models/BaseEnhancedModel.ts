...
export default class BaseEnhancedModel extends BaseModel {
    ...
    public static async findManyBy<
        M extends BaseEnhancedModelType,
        MA extends ModelAttributes<InstanceType<M>>,
    >(this: M, clause: Partial<MA>): Promise<InstanceType<M>[]>;
    public static async findManyBy<M extends BaseEnhancedModelType>(
        this: M,
        key: string,
        value: unknown
    ...
    public static async validateForUpdate<M extends BaseEnhancedModelType, MA extends ModelAttributes<InstanceType<M>>>(
        this: M,
        values: Partial<MA>,
    ): Promise<Partial<MA>> {
